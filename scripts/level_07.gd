...
var base_paths: Dictionary = {
		"kreis":    "res://assets/graphics/shapes/weis_kreis.tscn",
		"herz":     "res://assets/graphics/shapes/weis_herz.tscn",
		"dreieck":  "res://assets/graphics/shapes/weis_dreieck.tscn"
}
